              ...
              <tr>
                ...
                >
                  <div className="flex flex-col items-center justify-center gap-2">
                    <FaUserShield className="text-4xl text-gray-300 dark:text-gray-600" />
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                      {user.avatar_url ? (
                        <img
                          ...
                          className="w-10 h-10 rounded-full object-cover border border-gray-200 dark:border-gray-700 ring-2 ring-transparent group-hover:ring-blue-500/20 transition-all"
                        />
                      ) : (
                        <div className="w-10 h-10 rounded-full border-2 border-white dark:border-gray-700 bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 dark:text-gray-500">
                      ...
                      <div className="flex flex-col">
                        <div className="flex items-center gap-2">
                          ...
                          {currentUser?.id === user.id && (
                            <div
                              className="w-2.5 h-2.5 rounded-full bg-green-500 border border-white dark:border-gray-900 shadow-sm"
                              title="Sesión actual"
                            ></div>
                          )}
                        </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-wrap gap-2">
                      {user.provider === "google" && (
                        <div
                          className="flex items-center justify-center gap-2 px-2 py-1.5 w-24 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
                          title="Google"
                        >
                          <FcGoogle size={16} />
