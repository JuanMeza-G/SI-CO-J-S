    ...
    <Modal isOpen={isOpen} onClose={onClose} title={title}>
      <div className="flex flex-col items-center text-center gap-4">
        ...
        <div className="flex gap-3 w-full mt-4">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 dark:bg-[#1a1a1a] dark:hover:bg-[#242424] text-gray-700 dark:text-[#e5e5e5] rounded-lg transition-all font-bold cursor-pointer active:scale-95"
          >
            {cancelText}
          </button>
          <button
            onClick={onConfirm}
            className={`flex-1 px-4 py-2.5 ${buttonBgColor} text-white rounded-lg transition-all font-bold cursor-pointer active:scale-95`}
          >
            {confirmText}
          </button>
        </div>
